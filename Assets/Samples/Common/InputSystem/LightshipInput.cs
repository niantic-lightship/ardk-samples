...
public partial class @LightshipInput : IInputActionCollection2, IDisposable
{
    ...
    public struct InputActions
    {
        ...
        public void SetCallbacks(IInputActions instance)
        {
            ...
            {
                @PrimaryTouch.started -= m_Wrapper.m_InputActionsCallbackInterface.OnPrimaryTouch;
                @PrimaryTouch.performed -= m_Wrapper.m_InputActionsCallbackInterface.OnPrimaryTouch;
                @PrimaryTouch.canceled -= m_Wrapper.m_InputActionsCallbackInterface.OnPrimaryTouch;
                @SecondaryTouch.started -= m_Wrapper.m_InputActionsCallbackInterface.OnSecondaryTouch;
                @SecondaryTouch.performed -= m_Wrapper.m_InputActionsCallbackInterface.OnSecondaryTouch;
                @SecondaryTouch.canceled -= m_Wrapper.m_InputActionsCallbackInterface.OnSecondaryTouch;
                ...
                @MousePan.started -= m_Wrapper.m_InputActionsCallbackInterface.OnMousePan;
                @MousePan.performed -= m_Wrapper.m_InputActionsCallbackInterface.OnMousePan;
                @MousePan.canceled -= m_Wrapper.m_InputActionsCallbackInterface.OnMousePan;
                @MouseHold.started -= m_Wrapper.m_InputActionsCallbackInterface.OnMouseHold;
                @MouseHold.performed -= m_Wrapper.m_InputActionsCallbackInterface.OnMouseHold;
                @MouseHold.canceled -= m_Wrapper.m_InputActionsCallbackInterface.OnMouseHold;
